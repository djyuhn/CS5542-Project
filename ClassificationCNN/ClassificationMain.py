...
CATEGORIES = ['architecture', 'bridge', 'building', 'canal', 'canyon', 'cave', 'city', 'coast', 'desert', 'farm',
              'forest', 'hill', 'house', 'lake', 'library', 'mall', 'marketplace', 'mountain', 'ocean', 'plain',
              'river', 'skyscraper', 'town', 'village']
